...
* **Median (Q2)**: The median is represented by a line inside the box. It divides the dataset into two equal halves, with 50% of the data points lying below and 50% above this line. It provides a measure of the central tendancy of the data.
