           ...
           fluidPage(
             sidebarLayout(
               sidebarPanel(
                 ...
                 fluidRow(
                   numericInput("current_occupancy", "Current occupancy rate",           value = 92, step = 0.1, min = 0, max = 100),
                   numericInput("future_occupancy", "Future occupancy rate",             value = 85, step = 0.1, min = 0, max = 100)
                 ),
